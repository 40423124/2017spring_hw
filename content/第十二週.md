...
def setgearnumber(e):
    ...
    # 平移回原來的座標原點
    ctx.translate(-x17, -y17)
    gear17 = Spur(ctx).Gear(x17, y17, r17, n17, pa, "#B088FF")
    # 回復原有的座標系統
    ctx.restore()
    ...
    ctx.translate(-x11, -y11)
    gear11 = Spur(ctx).Gear(x11, y11, r11, n11, pa, "#B088FF")
    ctx.restore()
    ...
    ctx.translate(-x13, -y13)
    gear13 = Spur(ctx).Gear(x13, y13, r13, n13, pa, "#B088FF")
    ctx.restore()
...
心得:這次作業是畫三齒輪嚙合,聽老師說明後然後自己實際操作後才會知道問題